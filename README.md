...
> Currently it is supposed to run with [InfinitEID applet](https://github.com/Muzosh/InfinitEID), but by simply implementating an authenticate function it also works with other Web-eID compatible cards.
